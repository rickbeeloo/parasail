...
#define SG_FNAMEC parasail_sg_qb_dx
#define SG_FNAMED parasail_sg_qe_dx
#define SG_FNAMEE parasail_sg_qx_db
#define SG_FNAMEF parasail_sg_qx_de
...
#define SG_CASEC 1,0,1,1
#define SG_CASED 0,1,1,1
#define SG_CASEE 1,1,1,0
#define SG_CASEF 1,1,0,1
...
SG_IMPL(SG_FNAMEC, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASEC) \
SG_IMPL(SG_FNAMED, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASED) \
SG_IMPL(SG_FNAMEE, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASEE) \
SG_IMPL(SG_FNAMEF, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX, SG_CASEF)
...
SG_IMPL_PROF(SG_FNAMEC, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASEC) \
SG_IMPL_PROF(SG_FNAMED, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASED) \
SG_IMPL_PROF(SG_FNAMEE, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASEE) \
SG_IMPL_PROF(SG_FNAMEF, SG_STATSTRACE, SG_TABCOL, SG_SUFFIX_PROF, SG_CASEF)
